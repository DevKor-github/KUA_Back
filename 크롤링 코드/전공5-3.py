...
major00_200_400 = {'LIBS':'4653', 'LIET':'4656', 'LIFS':'5564', 'SMRT':'6727', 'PSYC':'6565', 'PHYS':'0212', 'MATH':'0211',  'EAES':'0215', 'CHEM':'0213', 'POLI':'0199',  'COSE':'5722', 'JMCO':'5257'  } 
...
# 데이터프레임을 CSV 파일로 저장
df.to_csv('전공5-3.csv', index=False, encoding='utf-8-sig')
print("CSV 파일로 저장 완료")
