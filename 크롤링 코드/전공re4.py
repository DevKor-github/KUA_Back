...
major00_100_500 = { 'SEMI':'6723' , 'NEIK':'7055' , 'ENGY':'6724' ,'DISS':'6910' , 'LING':'4391', 'KHPM':'5696', 'SMRT':'6727' , 'EDUC':'0236',  'MATE':'0239' , 'HISE':'0243', 'GEOG':'0242' , 'LESE':'4657','MEDI':'0229'}
...
# 데이터프레임을 CSV 파일로 저장
df.to_csv('전공4.csv', index=False, encoding='utf-8-sig')
print("CSV 파일로 저장 완료")
