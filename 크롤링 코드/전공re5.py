...
major00_200_500 = {'GKSS':'6911'  , 'BSMS':'5694' , 'HUSS':'7284' ,  'KHES':'5695' , 'LIFS':'5564', 'EGRN': '4065' , 'SOCI':'0152', 'HOEW':'0803', 'SPAN':'0158' ,  'EAES':'0215', 'LIET':'4656' , 'HANM':'0159' , 'POLI':'0199', 'PSYC':'6565'}
for key, value in major00_200_500.items():
...
# 데이터프레임을 CSV 파일로 저장
df.to_csv('전공5.csv', index=False, encoding='utf-8-sig')
print("CSV 파일로 저장 완료")
