...
from .models import Course, Tag, Post, PostImage, Comment, TimeTable
from .serializers import CourseSerializer, TagSerializer, PostSerializer, PostImageSerializer, CommentSerializer, TimeTableSerializer
