...
# major00_000_400 = {'KORE':'0145', 'HUSS':'7284', 'HOKA':'0148'}
# for key, value in major00_000_400.items():
...
# major00_000_100 = {'COOP':'7158'}
# for key, value in major00_000_100.items():
#     for num in [31, 32, 61, 62, 91, 121]:
#         for cour_cls in range(0, 10):
#             url = "https://infodepot.korea.ac.kr/lecture1/lecsubjectPlanView.jsp?year=2024&term=1R&grad_cd=0136&col_cd=9999&dept_cd="+ value +"&cour_cd=" + key + str(num).zfill(3) + "&cour_cls=" + str(cour_cls).zfill(2) + "&"
#             html = req.urlopen(url)
#             doc = BeautifulSoup(html,"html.parser")
...
#             #print(url)
#             print(f"{cour_number} 완료")
# major00_100_200 = {'EGRN': '4065', 'COMM':'7076', 'COLA':'4067', 'MOBI':'7095', 'PMED':'0228' }
...
for key, value in major00_100_500.items():
    for num in range (100, 600):
        for cour_cls in range(0, 10):
            ...
            #print(url)
            print(f"{cour_number} 완료")
# major00_200_400 = {'MECH': '4952', 'KMSE':'4630', 'KECE':'5597', 'NEIK':'7055', 'CHBE':'4084', 'RUSS':'0156', 'GERM':'0153', 'FRAN':'0154', 'HOEW':'0803', 'SOCI':'0152', 'SPAN':'0158', 'LING':'4391', 'ENGL':'0146', 'HANM':'0159',  'CHIN':'0155', 'JURA':'6459', 'BMED':'5693', 'KHPM':'5696',  'KHES':'5695', 'KLLE':'0240', 'MATE':'0239','PHEK':'0237', 'SAEK':'0237', 'LIBT':'4654', 'LIST':'4719', 'LIBS':'4653', 'LIET':'4656', 'LIFS':'5564', 'SMRT':'6727', 'PSYC':'6565', 'PHYS':'0212', 'MATH':'0211',  'EAES':'0215', 'CHEM':'0213', 'POLI':'0199',  'COSE':'5722', 'JMCO':'5257'  } 
